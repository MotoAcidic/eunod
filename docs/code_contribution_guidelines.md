...
reason, the eunod suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire eunod
...
One of the major design goals of all core eunod packages is to aim for complete
...
commits](https://github.com/MotoAcidic/eunod/commits/master) for examples of
commit messages.
...
contributions.  This is how to get your changes into eunod.
...
Rejoice as you will now be listed as a [contributor](https://github.com/MotoAcidic/eunod/graphs/contributors)!
...
[ISC license](https://github.com/MotoAcidic/eunod/blob/master/LICENSE).  This is
the same license as all of the code in the eunod suite.
