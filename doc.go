...
/*
eunod is a full-node bitcoin implementation written in Go.

The default options are sane for most users.  This means eunod will work 'out of
...
parsed when eunod starts up.  By default, the configuration file is located at
~/.eunod/eunod.conf on POSIX-style operating systems and %LOCALAPPDATA%\eunod\eunod.conf
...
Application Options:
  ...
  -d, --debuglevel=           Logging level for all subsystems {trace, debug,
      ...
      --miningaddr=           Add the specified payment address to the list of
                              ...
                              set
      --minrelaytxfee=        The minimum transaction fee in EUNO/kB to be
