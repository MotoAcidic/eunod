...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/MotoAcidic/eunod/eunoutil/coinset)
...
```bash
$ go get -u github.com/MotoAcidic/eunod/eunoutil/coinset
```
