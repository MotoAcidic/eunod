...
import (
	...
	"github.com/MotoAcidic/eunod/eunoutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    eunoutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() eunoutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value eunoutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	// should be two outpoints, with 1st one having 0.035EUNO value.
	...
	testSimpleCoinTxValue0            = eunoutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = eunoutil.NewTxFromBytes(testSimpleCoinTxBytes)
