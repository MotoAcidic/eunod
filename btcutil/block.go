...
// Tx returns a wrapped transaction (eunoutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (eunoutil.Tx) for all
...
// instead provides easy access to wrapped versions (eunoutil.Tx) of them.
