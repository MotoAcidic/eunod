...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/MotoAcidic/eunod/peer)
...
```bash
$ go get -u github.com/MotoAcidic/eunod/peer
```

## Examples

* [New Outbound Peer Example](https://pkg.go.dev/github.com/MotoAcidic/eunod/peer#example-package--NewOutboundPeer)  
