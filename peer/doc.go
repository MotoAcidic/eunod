...
function which allows a eunolog.Logger to be specified.  For example, logging at
...
(https://pkg.go.dev/github.com/MotoAcidic/eunod/wire#hdr-Bitcoin_Improvement_Proposals)
*/
package peer
