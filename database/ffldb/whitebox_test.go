...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*eunoutil.Block, error) {
	...
	blocks := make([]*eunoutil.Block, 0, 256)
	genesis := eunoutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
