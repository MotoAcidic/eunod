...
import (
	...
	peerpkg "github.com/MotoAcidic/eunod/peer"
...
func (sm *SyncManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*eunoutil.Block)
		if !ok {
...
// processed.
func (sm *SyncManager) QueueTx(tx *eunoutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *eunoutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *eunoutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
