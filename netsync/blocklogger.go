...
type blockProgressLogger struct {
	...
	subsystemLogger eunolog.Logger
...
func newBlockProgressLogger(progressMessage string, logger eunolog.Logger) *blockProgressLogger {
...
func (b *blockProgressLogger) LogBlockHeight(block *eunoutil.Block) {
	b.Lock()
	defer b.Unlock()
