...
func (c *Client) GenerateAsync(numBlocks uint32) FutureGenerateResult {
	cmd := eunojson.NewGenerateCmd(numBlocks)
...
func (c *Client) GenerateToAddressAsync(numBlocks int64, address eunoutil.Address, maxTries *int64) FutureGenerateToAddressResult {
	cmd := eunojson.NewGenerateToAddressCmd(numBlocks, address.EncodeAddress(), maxTries)
	return c.SendCmd(cmd)
}

// GenerateToAddress generates numBlocks blocks to the given address and returns their hashes.
func (c *Client) GenerateToAddress(numBlocks int64, address eunoutil.Address, maxTries *int64) ([]*chainhash.Hash, error) {
...
func (c *Client) GetGenerateAsync() FutureGetGenerateResult {
	cmd := eunojson.NewGetGenerateCmd()
	return c.SendCmd(cmd)
}
...
func (c *Client) SetGenerateAsync(enable bool, numCPUs int) FutureSetGenerateResult {
	cmd := eunojson.NewSetGenerateCmd(enable, &numCPUs)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetHashesPerSecAsync() FutureGetHashesPerSecResult {
	cmd := eunojson.NewGetHashesPerSecCmd()
	return c.SendCmd(cmd)
}
...
// information.
func (r FutureGetMiningInfoResult) Receive() (*eunojson.GetMiningInfoResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoResult eunojson.GetMiningInfoResult
...
func (c *Client) GetMiningInfoAsync() FutureGetMiningInfoResult {
	cmd := eunojson.NewGetMiningInfoCmd()
	return c.SendCmd(cmd)
}

// GetMiningInfo returns mining information.
func (c *Client) GetMiningInfo() (*eunojson.GetMiningInfoResult, error) {
...
func (c *Client) GetNetworkHashPSAsync() FutureGetNetworkHashPS {
	cmd := eunojson.NewGetNetworkHashPSCmd(nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetNetworkHashPS2Async(blocks int) FutureGetNetworkHashPS {
	cmd := eunojson.NewGetNetworkHashPSCmd(&blocks, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetNetworkHashPS3Async(blocks, height int) FutureGetNetworkHashPS {
	cmd := eunojson.NewGetNetworkHashPSCmd(&blocks, &height)
	return c.SendCmd(cmd)
}
...
// data to work on.
func (r FutureGetWork) Receive() (*eunojson.GetWorkResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var result eunojson.GetWorkResult
	err = json.Unmarshal(res, &result)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetWorkAsync() FutureGetWork {
	cmd := eunojson.NewGetWorkCmd(nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetWork() (*eunojson.GetWorkResult, error) {
...
func (c *Client) GetWorkSubmitAsync(data string) FutureGetWorkSubmit {
	cmd := eunojson.NewGetWorkCmd(&data)
	return c.SendCmd(cmd)
}
...
func (c *Client) SubmitBlockAsync(block *eunoutil.Block, options *eunojson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
	...
	cmd := eunojson.NewSubmitBlockCmd(blockHex, options)
	return c.SendCmd(cmd)
}

// SubmitBlock attempts to submit a new block into the bitcoin network.
func (c *Client) SubmitBlock(block *eunoutil.Block, options *eunojson.SubmitBlockOptions) error {
...
func (r FutureGetBlockTemplateResponse) Receive() (*eunojson.GetBlockTemplateResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a getwork result object.
	var result eunojson.GetBlockTemplateResult
	err = json.Unmarshal(res, &result)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetBlockTemplateAsync(req *eunojson.TemplateRequest) FutureGetBlockTemplateResponse {
	cmd := eunojson.NewGetBlockTemplateCmd(req)
	return c.SendCmd(cmd)
}

// GetBlockTemplate returns a new block template for mining.
func (c *Client) GetBlockTemplate(req *eunojson.TemplateRequest) (*eunojson.GetBlockTemplateResult, error) {
