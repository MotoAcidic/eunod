...
func (c *Client) AddNodeAsync(host string, command AddNodeCommand) FutureAddNodeResult {
	cmd := eunojson.NewAddNodeCmd(host, eunojson.AddNodeSubCmd(command))
...
func (c *Client) NodeAsync(command eunojson.NodeSubCmd, host string,
	connectSubCmd *string) FutureNodeResult {
	cmd := eunojson.NewNodeCmd(command, host, connectSubCmd)
	return c.SendCmd(cmd)
}
...
func (c *Client) Node(command eunojson.NodeSubCmd, host string,
...
func (r FutureGetAddedNodeInfoResult) Receive() ([]eunojson.GetAddedNodeInfoResult, error) {
	...
	var nodeInfo []eunojson.GetAddedNodeInfoResult
...
func (c *Client) GetAddedNodeInfoAsync(peer string) FutureGetAddedNodeInfoResult {
	cmd := eunojson.NewGetAddedNodeInfoCmd(true, &peer)
	return c.SendCmd(cmd)
}
...
// peers.
func (c *Client) GetAddedNodeInfo(peer string) ([]eunojson.GetAddedNodeInfoResult, error) {
...
func (c *Client) GetAddedNodeInfoNoDNSAsync(peer string) FutureGetAddedNodeInfoNoDNSResult {
	cmd := eunojson.NewGetAddedNodeInfoCmd(false, &peer)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetConnectionCountAsync() FutureGetConnectionCountResult {
	cmd := eunojson.NewGetConnectionCountCmd()
	return c.SendCmd(cmd)
}
...
// the current network.
func (r FutureGetNetworkInfoResult) Receive() (*eunojson.GetNetworkInfoResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var networkInfo eunojson.GetNetworkInfoResult
...
func (c *Client) GetNetworkInfoAsync() FutureGetNetworkInfoResult {
	cmd := eunojson.NewGetNetworkInfoCmd()
	return c.SendCmd(cmd)
}

// GetNetworkInfo returns data about the current network.
func (c *Client) GetNetworkInfo() (*eunojson.GetNetworkInfoResult, error) {
...
func (r FutureGetNodeAddressesResult) Receive() ([]eunojson.GetNodeAddressesResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var nodeAddresses []eunojson.GetNodeAddressesResult
...
func (c *Client) GetNodeAddressesAsync(count *int32) FutureGetNodeAddressesResult {
	cmd := eunojson.NewGetNodeAddressesCmd(count)
	return c.SendCmd(cmd)
}

// GetNodeAddresses returns data about known node addresses.
func (c *Client) GetNodeAddresses(count *int32) ([]eunojson.GetNodeAddressesResult, error) {
...
func (r FutureGetPeerInfoResult) Receive() ([]eunojson.GetPeerInfoResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as an array of getpeerinfo result objects.
	var peerInfo []eunojson.GetPeerInfoResult
...
func (c *Client) GetPeerInfoAsync() FutureGetPeerInfoResult {
	cmd := eunojson.NewGetPeerInfoCmd()
	return c.SendCmd(cmd)
}

// GetPeerInfo returns data about each connected network peer.
func (c *Client) GetPeerInfo() ([]eunojson.GetPeerInfoResult, error) {
...
// traffic statistics.
func (r FutureGetNetTotalsResult) Receive() (*eunojson.GetNetTotalsResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var totals eunojson.GetNetTotalsResult
...
func (c *Client) GetNetTotalsAsync() FutureGetNetTotalsResult {
	cmd := eunojson.NewGetNetTotalsCmd()
	return c.SendCmd(cmd)
}

// GetNetTotals returns network traffic statistics.
func (c *Client) GetNetTotals() (*eunojson.GetNetTotalsResult, error) {
