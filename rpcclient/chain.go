...
func (c *Client) GetBestBlockHashAsync() FutureGetBestBlockHashResult {
	cmd := eunojson.NewGetBestBlockHashCmd()
...
func (c *Client) legacyGetBlockRequest(hash string, verbose,
	...
	verboseJSON, err := json.Marshal(eunojson.Bool(verbose))
	if err != nil {
		return nil, err
	}
	verboseTxJSON, err := json.Marshal(eunojson.Bool(verboseTx))
	if err != nil {
		return nil, err
	}
...
func (c *Client) waitForGetBlockRes(respChan chan *Response, hash string,
	...
	// communicating with a eunod node which only understands the legacy
	// request, so we'll try that.
	if err, ok := err.(*eunojson.RPCError); ok &&
		err.Code == eunojson.ErrRPCInvalidParams.Code {
...
func (c *Client) GetBlockAsync(blockHash *chainhash.Hash) FutureGetBlockResult {
	...
	cmd := eunojson.NewGetBlockCmd(hash, eunojson.Int(0))
...
func (r FutureGetBlockVerboseResult) Receive() (*eunojson.GetBlockVerboseResult, error) {
	...
	var blockResult eunojson.GetBlockVerboseResult
...
func (c *Client) GetBlockVerboseAsync(blockHash *chainhash.Hash) FutureGetBlockVerboseResult {
	...
	cmd := eunojson.NewGetBlockCmd(hash, eunojson.Int(1))
...
func (c *Client) GetBlockVerbose(blockHash *chainhash.Hash) (*eunojson.GetBlockVerboseResult, error) {
...
func (r FutureGetBlockVerboseTxResult) Receive() (*eunojson.GetBlockVerboseTxResult, error) {
	res, err := r.client.waitForGetBlockRes(r.Response, r.hash, true, true)
	if err != nil {
		return nil, err
	}

	var blockResult eunojson.GetBlockVerboseTxResult
	err = json.Unmarshal(res, &blockResult)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetBlockVerboseTxAsync(blockHash *chainhash.Hash) FutureGetBlockVerboseTxResult {
	...
	cmd := eunojson.NewGetBlockCmd(hash, eunojson.Int(2))
...
// See GetBlock to retrieve a raw block instead.
func (c *Client) GetBlockVerboseTx(blockHash *chainhash.Hash) (*eunojson.GetBlockVerboseTxResult, error) {
...
func (c *Client) GetBlockCountAsync() FutureGetBlockCountResult {
	cmd := eunojson.NewGetBlockCountCmd()
	return c.SendCmd(cmd)
}
...
func (r FutureGetChainTxStatsResult) Receive() (*eunojson.GetChainTxStatsResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var chainTxStats eunojson.GetChainTxStatsResult
...
func (c *Client) GetChainTxStatsAsync() FutureGetChainTxStatsResult {
	cmd := eunojson.NewGetChainTxStatsCmd(nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetChainTxStatsNBlocksAsync(nBlocks int32) FutureGetChainTxStatsResult {
	cmd := eunojson.NewGetChainTxStatsCmd(&nBlocks, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetChainTxStatsNBlocksBlockHashAsync(nBlocks int32, blockHash chainhash.Hash) FutureGetChainTxStatsResult {
	hash := blockHash.String()
	cmd := eunojson.NewGetChainTxStatsCmd(&nBlocks, &hash)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetChainTxStats() (*eunojson.GetChainTxStatsResult, error) {
...
func (c *Client) GetChainTxStatsNBlocks(nBlocks int32) (*eunojson.GetChainTxStatsResult, error) {
...
func (c *Client) GetChainTxStatsNBlocksBlockHash(nBlocks int32, blockHash chainhash.Hash) (*eunojson.GetChainTxStatsResult, error) {
...
func (c *Client) GetDifficultyAsync() FutureGetDifficultyResult {
	cmd := eunojson.NewGetDifficultyCmd()
	return c.SendCmd(cmd)
}
...
func unmarshalPartialGetBlockChainInfoResult(res []byte) (*eunojson.GetBlockChainInfoResult, error) {
	var chainInfo eunojson.GetBlockChainInfoResult
...
func unmarshalGetBlockChainInfoResultSoftForks(chainInfo *eunojson.GetBlockChainInfoResult,
	version BackendVersion, res []byte) error {

	switch version {
	// Versions of bitcoind on or after v0.19.0 use the unified format.
	case BitcoindPost19:
		var softForks eunojson.UnifiedSoftForks
	...
	default:
		var softForks eunojson.SoftForks
		if err := json.Unmarshal(res, &softForks); err != nil {
			return err
		}
...
func (r FutureGetBlockChainInfoResult) Receive() (*eunojson.GetBlockChainInfoResult, error) {
...
func (c *Client) GetBlockChainInfoAsync() FutureGetBlockChainInfoResult {
	cmd := eunojson.NewGetBlockChainInfoCmd()
...
// of the main chain.
func (c *Client) GetBlockChainInfo() (*eunojson.GetBlockChainInfoResult, error) {
...
// result provided by the server.
func (r FutureGetBlockFilterResult) Receive() (*eunojson.GetBlockFilterResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var blockFilter eunojson.GetBlockFilterResult
...
func (c *Client) GetBlockFilterAsync(blockHash chainhash.Hash, filterType *eunojson.FilterTypeName) FutureGetBlockFilterResult {
	hash := blockHash.String()

	cmd := eunojson.NewGetBlockFilterCmd(hash, filterType)
	return c.SendCmd(cmd)
}

// GetBlockFilter retrieves a BIP0157 content filter for a particular block.
func (c *Client) GetBlockFilter(blockHash chainhash.Hash, filterType *eunojson.FilterTypeName) (*eunojson.GetBlockFilterResult, error) {
...
func (c *Client) GetBlockHashAsync(blockHeight int64) FutureGetBlockHashResult {
	cmd := eunojson.NewGetBlockHashCmd(blockHeight)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderAsync(blockHash *chainhash.Hash) FutureGetBlockHeaderResult {
	...
	cmd := eunojson.NewGetBlockHeaderCmd(hash, eunojson.Bool(false))
	return c.SendCmd(cmd)
}
...
func (r FutureGetBlockHeaderVerboseResult) Receive() (*eunojson.GetBlockHeaderVerboseResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a string.
	var bh eunojson.GetBlockHeaderVerboseResult
...
func (c *Client) GetBlockHeaderVerboseAsync(blockHash *chainhash.Hash) FutureGetBlockHeaderVerboseResult {
	...
	cmd := eunojson.NewGetBlockHeaderCmd(hash, eunojson.Bool(true))
	return c.SendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderVerbose(blockHash *chainhash.Hash) (*eunojson.GetBlockHeaderVerboseResult, error) {
...
// its hash.
func (r FutureGetMempoolEntryResult) Receive() (*eunojson.GetMempoolEntryResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var mempoolEntryResult eunojson.GetMempoolEntryResult
...
func (c *Client) GetMempoolEntryAsync(txHash string) FutureGetMempoolEntryResult {
	cmd := eunojson.NewGetMempoolEntryCmd(txHash)
	return c.SendCmd(cmd)
}

// GetMempoolEntry returns a data structure with information about the
// transaction in the memory pool given its hash.
func (c *Client) GetMempoolEntry(txHash string) (*eunojson.GetMempoolEntryResult, error) {
...
func (c *Client) GetRawMempoolAsync() FutureGetRawMempoolResult {
	cmd := eunojson.NewGetRawMempoolCmd(eunojson.Bool(false))
	return c.SendCmd(cmd)
}
...
func (r FutureGetRawMempoolVerboseResult) Receive() (map[string]eunojson.GetRawMempoolVerboseResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// results.
	var mempoolItems map[string]eunojson.GetRawMempoolVerboseResult
...
func (c *Client) GetRawMempoolVerboseAsync() FutureGetRawMempoolVerboseResult {
	cmd := eunojson.NewGetRawMempoolCmd(eunojson.Bool(true))
	return c.SendCmd(cmd)
}
...
func (c *Client) GetRawMempoolVerbose() (map[string]eunojson.GetRawMempoolVerboseResult, error) {
...
func (c *Client) EstimateFeeAsync(numBlocks int64) FutureEstimateFeeResult {
	cmd := eunojson.NewEstimateFeeCmd(numBlocks)
	return c.SendCmd(cmd)
}
...
// Receive waits for the Response promised by the future and returns the
// estimated fee.
func (r FutureEstimateSmartFeeResult) Receive() (*eunojson.EstimateSmartFeeResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var verified eunojson.EstimateSmartFeeResult
...
func (c *Client) EstimateSmartFeeAsync(confTarget int64, mode *eunojson.EstimateSmartFeeMode) FutureEstimateSmartFeeResult {
	cmd := eunojson.NewEstimateSmartFeeCmd(confTarget, mode)
	return c.SendCmd(cmd)
}

// EstimateSmartFee requests the server to estimate a fee level based on the given parameters.
func (c *Client) EstimateSmartFee(confTarget int64, mode *eunojson.EstimateSmartFeeMode) (*eunojson.EstimateSmartFeeResult, error) {
...
func (c *Client) VerifyChainAsync() FutureVerifyChainResult {
	cmd := eunojson.NewVerifyChainCmd(nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) VerifyChainLevelAsync(checkLevel int32) FutureVerifyChainResult {
	cmd := eunojson.NewVerifyChainCmd(&checkLevel, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) VerifyChainBlocksAsync(checkLevel, numBlocks int32) FutureVerifyChainResult {
	cmd := eunojson.NewVerifyChainCmd(&checkLevel, &numBlocks)
	return c.SendCmd(cmd)
}
...
func (r FutureGetTxOutResult) Receive() (*eunojson.GetTxOutResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var txOutInfo *eunojson.GetTxOutResult
...
func (c *Client) GetTxOutAsync(txHash *chainhash.Hash, index uint32, mempool bool) FutureGetTxOutResult {
	...
	cmd := eunojson.NewGetTxOutCmd(hash, index, &mempool)
	return c.SendCmd(cmd)
}

// GetTxOut returns the transaction output info if it's unspent and
// nil, otherwise.
func (c *Client) GetTxOut(txHash *chainhash.Hash, index uint32, mempool bool) (*eunojson.GetTxOutResult, error) {
...
func (r FutureGetTxOutSetInfoResult) Receive() (*eunojson.GetTxOutSetInfoResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var txOutSetInfo *eunojson.GetTxOutSetInfoResult
...
func (c *Client) GetTxOutSetInfoAsync() FutureGetTxOutSetInfoResult {
	cmd := eunojson.NewGetTxOutSetInfoCmd()
	return c.SendCmd(cmd)
}

// GetTxOutSetInfo returns the statistics about the unspent transaction output
// set.
func (c *Client) GetTxOutSetInfo() (*eunojson.GetTxOutSetInfoResult, error) {
...
//
// NOTE: This is a MotoAcidic extension ported from
...
// NOTE: This is a MotoAcidic extension ported from
// github.com/decred/dcrrpcclient.
func (r FutureRescanBlocksResult) Receive() ([]eunojson.RescannedBlock, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var rescanBlocksResult []eunojson.RescannedBlock
...
func (c *Client) RescanBlocksAsync(blockHashes []chainhash.Hash) FutureRescanBlocksResult {
	...
	cmd := eunojson.NewRescanBlocksCmd(strBlockHashes)
	return c.SendCmd(cmd)
}
...
// NOTE: This is a MotoAcidic extension ported from
// github.com/decred/dcrrpcclient.
func (c *Client) RescanBlocks(blockHashes []chainhash.Hash) ([]eunojson.RescannedBlock, error) {
...
func (c *Client) InvalidateBlockAsync(blockHash *chainhash.Hash) FutureInvalidateBlockResult {
	...
	cmd := eunojson.NewInvalidateBlockCmd(hash)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetCFilterAsync(blockHash *chainhash.Hash,
	...
	cmd := eunojson.NewGetCFilterCmd(hash, filterType)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetCFilterHeaderAsync(blockHash *chainhash.Hash,
	...
	cmd := eunojson.NewGetCFilterHeaderCmd(hash, filterType)
	return c.SendCmd(cmd)
}
...
func (r FutureGetBlockStatsResult) Receive() (*eunojson.GetBlockStatsResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var blockStats eunojson.GetBlockStatsResult
...
func (c *Client) GetBlockStatsAsync(hashOrHeight interface{}, stats *[]string) FutureGetBlockStatsResult {
	...
	cmd := eunojson.NewGetBlockStatsCmd(eunojson.HashOrHeight{Value: hashOrHeight}, stats)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetBlockStats(hashOrHeight interface{}, stats *[]string) (*eunojson.GetBlockStatsResult, error) {
...
func (r FutureDeriveAddressesResult) Receive() (*eunojson.DeriveAddressesResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var deriveAddressesResult eunojson.DeriveAddressesResult
...
func (c *Client) DeriveAddressesAsync(descriptor string, descriptorRange *eunojson.DescriptorRange) FutureDeriveAddressesResult {
	cmd := eunojson.NewDeriveAddressesCmd(descriptor, descriptorRange)
	return c.SendCmd(cmd)
}
...
func (c *Client) DeriveAddresses(descriptor string, descriptorRange *eunojson.DescriptorRange) (*eunojson.DeriveAddressesResult, error) {
...
func (r FutureGetDescriptorInfoResult) Receive() (*eunojson.GetDescriptorInfoResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var descriptorInfo eunojson.GetDescriptorInfoResult
...
func (c *Client) GetDescriptorInfoAsync(descriptor string) FutureGetDescriptorInfoResult {
	cmd := eunojson.NewGetDescriptorInfoCmd(descriptor)
	return c.SendCmd(cmd)
}
...
//
// See eunojson.GetDescriptorInfoResult for details about the result.
func (c *Client) GetDescriptorInfo(descriptor string) (*eunojson.GetDescriptorInfoResult, error) {
