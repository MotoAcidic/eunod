...
//
// NOTE: This is a eunod extension.
func (c *Client) DebugLevelAsync(levelSpec string) FutureDebugLevelResult {
	cmd := eunojson.NewDebugLevelCmd(levelSpec)
...
func (r FutureListAddressTransactionsResult) Receive() ([]eunojson.ListTransactionsResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
...
//
// NOTE: This is a eunod extension.
func (c *Client) ListAddressTransactionsAsync(addresses []eunoutil.Address, account string) FutureListAddressTransactionsResult {
	// Convert addresses to strings.
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.EncodeAddress())
	}
	cmd := eunojson.NewListAddressTransactionsCmd(addrs, &account)
	return c.SendCmd(cmd)
}
...
//
// NOTE: This is a eunowallet extension.
func (c *Client) ListAddressTransactions(addresses []eunoutil.Address, account string) ([]eunojson.ListTransactionsResult, error) {
...
func (r FutureGetBestBlockResult) Receive() (*chainhash.Hash, int32, error) {
	...
	var bestBlock eunojson.GetBestBlockResult
...
func (c *Client) GetBestBlockAsync() FutureGetBestBlockResult {
	cmd := eunojson.NewGetBestBlockCmd()
	return c.SendCmd(cmd)
}
...
func (c *Client) GetCurrentNetAsync() FutureGetCurrentNetResult {
	cmd := eunojson.NewGetCurrentNetCmd()
	return c.SendCmd(cmd)
}
...
func (c *Client) GetHeadersAsync(blockLocators []chainhash.Hash, hashStop *chainhash.Hash) FutureGetHeadersResult {
	...
	cmd := eunojson.NewGetHeadersCmd(locators, hash)
	return c.SendCmd(cmd)
}
...
func (c *Client) ExportWatchingWalletAsync(account string) FutureExportWatchingWalletResult {
	cmd := eunojson.NewExportWatchingWalletCmd(&account, eunojson.Bool(true))
	return c.SendCmd(cmd)
}
...
// used by eunowallet to enable a wallet which does not have the private keys
...
// Receive waits for the Response promised by the future and returns the
// session result.
func (r FutureSessionResult) Receive() (*eunojson.SessionResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var session eunojson.SessionResult
...
//
// NOTE: This is a MotoAcidic extension.
...
//
// NOTE: This is a MotoAcidic extension.
func (c *Client) Session() (*eunojson.SessionResult, error) {
...
// NOTE: This is a MotoAcidic extension ported from
// github.com/decred/dcrrpcclient.
func (r FutureVersionResult) Receive() (map[string]eunojson.VersionResult,
	error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	...
	var vr map[string]eunojson.VersionResult
...
// NOTE: This is a MotoAcidic extension ported from
// github.com/decred/dcrrpcclient.
func (c *Client) Version() (map[string]eunojson.VersionResult, error) {
