...
const (
	...
	defaultMaxFeeRate = eunoutil.SatoshiPerBitcoin / 10
)
...
func (r FutureGetRawTransactionResult) Receive() (*eunoutil.Tx, error) {
	...
	return eunoutil.NewTx(&msgTx), nil
}
...
func (c *Client) GetRawTransactionAsync(txHash *chainhash.Hash) FutureGetRawTransactionResult {
	...
	cmd := eunojson.NewGetRawTransactionCmd(hash, eunojson.Int(0))
...
// transaction.
func (c *Client) GetRawTransaction(txHash *chainhash.Hash) (*eunoutil.Tx, error) {
...
func (r FutureGetRawTransactionVerboseResult) Receive() (*eunojson.TxRawResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var rawTxResult eunojson.TxRawResult
...
func (c *Client) GetRawTransactionVerboseAsync(txHash *chainhash.Hash) FutureGetRawTransactionVerboseResult {
	...
	cmd := eunojson.NewGetRawTransactionCmd(hash, eunojson.Int(1))
	return c.SendCmd(cmd)
}
...
func (c *Client) GetRawTransactionVerbose(txHash *chainhash.Hash) (*eunojson.TxRawResult, error) {
...
func (r FutureDecodeRawTransactionResult) Receive() (*eunojson.TxRawResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) DecodeRawTransactionAsync(serializedTx []byte) FutureDecodeRawTransactionResult {
	...
	cmd := eunojson.NewDecodeRawTransactionCmd(txHex)
	return c.SendCmd(cmd)
}

// DecodeRawTransaction returns information about a transaction given its
// serialized bytes.
func (c *Client) DecodeRawTransaction(serializedTx []byte) (*eunojson.TxRawResult, error) {
...
func (r FutureFundRawTransactionResult) Receive() (*eunojson.FundRawTransactionResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var marshalled eunojson.FundRawTransactionResult
...
func (c *Client) FundRawTransactionAsync(tx *wire.MsgTx, opts eunojson.FundRawTransactionOpts, isWitness *bool) FutureFundRawTransactionResult {
	var txBuf bytes.Buffer
	if err := tx.Serialize(&txBuf); err != nil {
		return newFutureError(err)
	}

	cmd := eunojson.NewFundRawTransactionCmd(txBuf.Bytes(), opts, isWitness)
	return c.SendCmd(cmd)
}

// FundRawTransaction returns the result of trying to fund the given transaction with
// funds from the node wallet
func (c *Client) FundRawTransaction(tx *wire.MsgTx, opts eunojson.FundRawTransactionOpts, isWitness *bool) (*eunojson.FundRawTransactionResult, error) {
...
func (c *Client) CreateRawTransactionAsync(inputs []eunojson.TransactionInput,
	amounts map[eunoutil.Address]eunoutil.Amount, lockTime *int64) FutureCreateRawTransactionResult {

	convertedAmts := make(map[string]float64, len(amounts))
	for addr, amount := range amounts {
		convertedAmts[addr.String()] = amount.ToEUNO()
	}
	cmd := eunojson.NewCreateRawTransactionCmd(inputs, convertedAmts, lockTime)
	return c.SendCmd(cmd)
}
...
func (c *Client) CreateRawTransaction(inputs []eunojson.TransactionInput,
	amounts map[eunoutil.Address]eunoutil.Amount, lockTime *int64) (*wire.MsgTx, error) {
...
func (c *Client) SendRawTransactionAsync(tx *wire.MsgTx, allowHighFees bool) FutureSendRawTransactionResult {
	...
	var cmd *eunojson.SendRawTransactionCmd
	switch version {
	...
	case BitcoindPost19:
		...
		cmd = eunojson.NewBitcoindSendRawTransactionCmd(txHex, maxFeeRate)

	// Otherwise, use the AllowHighFees field.
	default:
		cmd = eunojson.NewSendRawTransactionCmd(txHex, &allowHighFees)
	}
...
func (r FutureSignRawTransactionResult) Receive() (*wire.MsgTx, bool, error) {
	...
	var signRawTxResult eunojson.SignRawTransactionResult
...
func (c *Client) SignRawTransactionAsync(tx *wire.MsgTx) FutureSignRawTransactionResult {
	...
	cmd := eunojson.NewSignRawTransactionCmd(txHex, nil, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) SignRawTransaction2Async(tx *wire.MsgTx, inputs []eunojson.RawTxInput) FutureSignRawTransactionResult {
	txHex := ""
	if tx != nil {
		// Serialize the transaction and convert to hex string.
		buf := bytes.NewBuffer(make([]byte, 0, tx.SerializeSize()))
	...
	cmd := eunojson.NewSignRawTransactionCmd(txHex, &inputs, nil, nil)
	return c.SendCmd(cmd)
}
...
// transactions.
func (c *Client) SignRawTransaction2(tx *wire.MsgTx, inputs []eunojson.RawTxInput) (*wire.MsgTx, bool, error) {
...
func (c *Client) SignRawTransaction3Async(tx *wire.MsgTx,
	...
	cmd := eunojson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) SignRawTransaction4Async(tx *wire.MsgTx,
	inputs []eunojson.RawTxInput, privKeysWIF []string,
	...
	cmd := eunojson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		eunojson.String(string(hashType)))
	return c.SendCmd(cmd)
}
...
func (r FutureSignRawTransactionWithWalletResult) Receive() (*wire.MsgTx, bool, error) {
	...
	var signRawTxWithWalletResult eunojson.SignRawTransactionWithWalletResult
...
func (c *Client) SignRawTransactionWithWalletAsync(tx *wire.MsgTx) FutureSignRawTransactionWithWalletResult {
	...
	cmd := eunojson.NewSignRawTransactionWithWalletCmd(txHex, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) SignRawTransactionWithWallet2Async(tx *wire.MsgTx,
	inputs []eunojson.RawTxWitnessInput) FutureSignRawTransactionWithWalletResult {
	...
	cmd := eunojson.NewSignRawTransactionWithWalletCmd(txHex, &inputs, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) SignRawTransactionWithWallet2(tx *wire.MsgTx,
	inputs []eunojson.RawTxWitnessInput) (*wire.MsgTx, bool, error) {
...
func (c *Client) SignRawTransactionWithWallet3Async(tx *wire.MsgTx,
	inputs []eunojson.RawTxWitnessInput, hashType SigHashType) FutureSignRawTransactionWithWalletResult {
	...
	cmd := eunojson.NewSignRawTransactionWithWalletCmd(txHex, &inputs, eunojson.String(string(hashType)))
	return c.SendCmd(cmd)
}
...
func (c *Client) SignRawTransactionWithWallet3(tx *wire.MsgTx,
	inputs []eunojson.RawTxWitnessInput, hashType SigHashType) (*wire.MsgTx, bool, error) {
...
func (c *Client) SearchRawTransactionsAsync(address eunoutil.Address, skip, count int, reverse bool, filterAddrs []string) FutureSearchRawTransactionsResult {
	addr := address.EncodeAddress()
	verbose := eunojson.Int(0)
	cmd := eunojson.NewSearchRawTransactionsCmd(addr, verbose, &skip, &count,
...
func (c *Client) SearchRawTransactions(address eunoutil.Address, skip, count int, reverse bool, filterAddrs []string) ([]*wire.MsgTx, error) {
...
// Receive waits for the Response promised by the future and returns the
// found raw transactions.
func (r FutureSearchRawTransactionsVerboseResult) Receive() ([]*eunojson.SearchRawTransactionsResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var result []*eunojson.SearchRawTransactionsResult
...
func (c *Client) SearchRawTransactionsVerboseAsync(address eunoutil.Address, skip,
	count int, includePrevOut, reverse bool, filterAddrs *[]string) FutureSearchRawTransactionsVerboseResult {

	addr := address.EncodeAddress()
	verbose := eunojson.Int(1)
	var prevOut *int
	if includePrevOut {
		prevOut = eunojson.Int(1)
	}
	cmd := eunojson.NewSearchRawTransactionsCmd(addr, verbose, &skip, &count,
...
func (c *Client) SearchRawTransactionsVerbose(address eunoutil.Address, skip,
	count int, includePrevOut, reverse bool, filterAddrs []string) ([]*eunojson.SearchRawTransactionsResult, error) {
...
func (r FutureDecodeScriptResult) Receive() (*eunojson.DecodeScriptResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var decodeScriptResult eunojson.DecodeScriptResult
...
func (c *Client) DecodeScriptAsync(serializedScript []byte) FutureDecodeScriptResult {
	...
	cmd := eunojson.NewDecodeScriptCmd(scriptHex)
	return c.SendCmd(cmd)
}

// DecodeScript returns information about a script given its serialized bytes.
func (c *Client) DecodeScript(serializedScript []byte) (*eunojson.DecodeScriptResult, error) {
