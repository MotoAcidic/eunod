...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/MotoAcidic/eunod/connmgr)
...
```bash
$ go get -u github.com/MotoAcidic/eunod/connmgr
```
