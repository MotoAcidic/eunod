...
func TestFeeFilterLatest(t *testing.T) {
	...
	err := msg.EunoEncode(&buf, pver, BaseEncoding)
	if err != nil {
	...
	err = readmsg.EunoDecode(&buf, pver, BaseEncoding)
	if err != nil {
...
func TestFeeFilterWire(t *testing.T) {
	...
	for i, test := range tests {
		...
		var buf bytes.Buffer
		err := test.in.EunoEncode(&buf, test.pver, BaseEncoding)
		if err != nil {
		...
		err = msg.EunoDecode(rbuf, test.pver, BaseEncoding)
		if err != nil {
...
func TestFeeFilterWireErrors(t *testing.T) {
	...
	for i, test := range tests {
		...
		err := test.in.EunoEncode(w, test.pver, BaseEncoding)
		...
		err = msg.EunoDecode(r, test.pver, BaseEncoding)
