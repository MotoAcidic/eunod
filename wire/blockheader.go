...
func (h *BlockHeader) EunoDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
...
func (h *BlockHeader) EunoEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
