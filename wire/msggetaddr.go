...
func (msg *MsgGetAddr) EunoDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	return nil
}

// EunoEncode encodes the receiver to w using the bitcoin protocol encoding.
// This is part of the Message interface implementation.
func (msg *MsgGetAddr) EunoEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
	return nil
}
