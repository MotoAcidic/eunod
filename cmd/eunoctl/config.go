...
import (
	...
	"github.com/MotoAcidic/eunod/btcjson"
	"github.com/MotoAcidic/eunod/chaincfg"
	"github.com/MotoAcidic/eunod/btcutil"
...
var (
	btcdHomeDir           = btcutil.AppDataDir("eunod", false)
...
func loadConfig() (*config, []string, error) {
	...
	if _, err := os.Stat(preCfg.ConfigFile); os.IsNotExist(err) {
		...
		if preCfg.Wallet {
			...
			serverConfigPath = filepath.Join(btcdHomeDir, "eunod.conf")
		}
...
// For this it tries to read the config file for the RPC server (either eunod or
