...
// candidates at the last checkpoint that is already hard coded into eunochain
...
// uses the format the eunochain code expects for checkpoints added to the list.
