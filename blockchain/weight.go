...
func GetBlockWeight(blk *eunoutil.Block) int64 {
...
func GetTransactionWeight(tx *eunoutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *eunoutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
