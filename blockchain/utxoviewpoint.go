...
func (view *UtxoViewpoint) AddTxOut(tx *eunoutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *eunoutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *eunoutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *eunoutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *eunoutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *eunoutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *eunoutil.Tx) (*UtxoViewpoint, error) {
