...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*eunoutil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *eunoutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *eunoutil.Block) error {
