...
func isPubKey(script []byte) (bool, []byte) {
	...
	if len(script) == 35 && script[0] == txscript.OP_DATA_33 &&
		...
		_, err := eunoec.ParsePubKey(serializedPubKey)
		if err == nil {
...
func decompressScript(compressedPkScript []byte) []byte {
	...
	case cstPayToPubKeyUncomp4, cstPayToPubKeyUncomp5:
		...
		key, err := eunoec.ParsePubKey(compressedKey)
		if err != nil {
			return nil
		}
...
// of 0.1 EUNO which is 10000000 satoshi.  Encoding 10000000 as a VLQ would take
...
//            0 (1) -> 0        (1)           *  0.00000000 EUNO
//         1000 (2) -> 4        (1)           *  0.00001000 EUNO
//        10000 (2) -> 5        (1)           *  0.00010000 EUNO
//     12345678 (4) -> 111111101(4)           *  0.12345678 EUNO
//     50000000 (4) -> 47       (1)           *  0.50000000 EUNO
//    100000000 (4) -> 9        (1)           *  1.00000000 EUNO
//    500000000 (5) -> 49       (1)           *  5.00000000 EUNO
//   1000000000 (5) -> 10       (1)           * 10.00000000 EUNO
// -----------------------------------------------------------------------------
