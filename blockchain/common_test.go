...
// eunoutil.Block.  This is largely borrowed from the test code in eunodb.
func loadBlocks(filename string) (blocks []*eunoutil.Block, err error) {
	...
	for height := int64(1); err == nil; height++ {
		...
		block, err = eunoutil.NewBlockFromBytes(rbytes)
		if err != nil {
			return
		}
