...
func storeFilter(dbTx database.Tx, block *eunoutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *eunoutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *eunoutil.Block,
